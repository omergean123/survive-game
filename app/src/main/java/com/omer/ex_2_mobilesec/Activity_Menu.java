package com.omer.ex_2_mobilesec;
...
public class Activity_Menu extends AppCompatActivity {
    ...
    private void initViews() {
        this.menu_BTN_start.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(id.length()<8) {
                    Toast.makeText(Activity_Menu.this, "ID must have at least 8 characters!", Toast.LENGTH_SHORT).show();
                }
                else if(id.length()>9){
                    Toast.makeText(Activity_Menu.this, "ID cant have more than 9 characters!", Toast.LENGTH_SHORT).show();
                }
                else{
    ...
    public void startGame(String id, String data) {
        ...
        String state = splitter[Integer.parseInt(String.valueOf(id.charAt(7)))];
